...
8. **虚拟形象模因**：严禁writer随意发挥硬凹「虚拟形象」，世界观中，furry、非人类种族存在，如果writer将其强行写成「虚拟形象」必须要求更正。
...
10. **AI 式翻译腔（生硬英式直译）**：禁止明显不符合中文习惯、由英文叙述套路直译而来的表述。**必检**：如「开口道」「缓缓开口」「顿了顿道」「沉默了片刻道」「他开口说」「她缓缓说道」等——中文自然表达多用「说」「道」「问」「答」直接引出对话，或「他/她+动词」简洁带过，无需「开口」「缓缓开口」这类英式「opened his mouth」「said slowly」的套话。同类还包括高频、无信息量的动作套话，请紧盯以下现象：「点了点头」「摇了摇头」过度堆砌、「他/她顿了顿」「重新看向」「目光重新落在某人身上」「转向某人」「转头看向他/她」「抬起头看向……」「一直安静的……」「打破死寂」「打破了寂静」「目光锐利」「抬了抬下巴」还有与时间相关的「下一秒」「同一时刻」等。凡此类句子，直接视作**没有承载新的情节信息或人物心理，只是机械描述视线/动作变化**，必须删除。**不误伤**：经典文学译本的翻译腔、适度欧化句式、以及「他沉吟道」「他低声道」等已融入中文的常见写法，不判不通过；仅对明显生硬、AI 常见的英式叙述套话和上述「重新看向/转向某人」这类无信息 filler 判不通过。审稿时须在原因中列出具体句例，并建议改为真正推动情节或体现人物心理的描写。 
...
13. **游戏/电影模版待机动作 filler（仅拦截不合理用法）**：
...
15. **神经质网文形容词（收窄版，只拦截“负面/刻板/丑陋化”文法）**：本条只针对会把语气/动作/情绪写成**病态夸张、兽化/尸化、丑陋化**的刻板模板用法，出现且明显拉低质感时判为不通过；不要把“口语化、轻佻、俏皮吐槽、略带夸张的日常说法”误判为神经质。
...
16. **在低技术条件下引入“光屏”**：本条识别具有一定的难度，需要仔细甄别。在魔法/赛博朋克世界中，会出现“全息投影”、“光屏”、“星图”等意象，这是合理的，但注意在这种世界中存在着低技术条件或艰苦的局部场景，在这些场景下不应该出现以上意象。需注意，你只需要盯以上三种意象，不要将范围扩大化。
17. **通讯器模因**：禁止使用“通讯器 / 数据板 / 终端”等词，手机就是手机、平板就是平板，iPhone就是iPhone，若强行做“风格升级”，视为违规，必须更正。
18. **宠物化模因**：禁止用宠物化方式写亚人种族，视为违规，必须更正。
...
7. **段落开头策略分析**：
   ...
   - 另外，警惕应试教育推崇的“总分总”结构，尤其注意头3段直接泄露全章意图的写法，哪怕再隐蔽都必须找出来，你需要提醒writer小说是宏达篇章中的一小段，绝对不得套用“总分总”结构。
