...
10. **AI 式翻译腔（生硬英式叙述套话）**：禁止明显不符合中文习惯、由英文叙述套路直译而来的表述。**必检**：如「开口道」「缓缓开口」「顿了顿道」「沉默了片刻道」「他开口说」「她缓缓说道」等——中文自然表达多用「说」「道」「问」「答」直接引出对话，或「他/她+动词」简洁带过，无需「开口」「缓缓开口」这类英式「opened his mouth」「said slowly」的套话。同类还包括高频、无信息量的动作套话，例如：「点了点头」「摇了摇头」过度堆砌、「他/她顿了顿」「重新看向」「目光重新落在某人身上」「转向某人」「转头看向他/她」「抬起头看向……」「打破死寂」「打破了寂静」「目光锐利」「抬了抬下巴」还有与时间相关的「下一秒」「同一时刻」等。凡此类句子若**没有承载新的情节信息或人物心理，只是机械描述视线/动作变化**，一律视为问题表达。**不误伤**：经典文学译本的翻译腔、适度欧化句式、以及「他沉吟道」「他低声道」等已融入中文的常见写法，不判不通过；仅对明显生硬、AI 常见的英式叙述套话和上述「重新看向/转向某人」这类无信息 filler 判不通过。审稿时须在原因中列出具体句例，并建议改为真正推动情节或体现人物心理的描写。 
...
13. **游戏/电影模版待机动作 filler**：禁止使用明显源自游戏/电影镜头语言、却没有实际推动剧情的待机动作作为句子填充，例如「她活动了一下手腕」「他握着剑柄」「她望向窗外/远方」「他整理了一下衣领/衣摆」「两人对视了一眼又同时移开目光」「踢石子」「身体坐直」「身体前倾」等，如果这些动作既不推动情节也不体现人物性格，只是为了填字或拖时间，一律视为问题。审稿时若发现此类 filler，应在原因中指出具体句子，并要求改为真正服务情节/人物的动作描写，或直接删除。
14. **匕首抛光综合征（收窄版，避免误伤）**：
