...
10. **叙述者解释剧情/动机/因果**：正文中不得用叙述者口吻或旁白直接解释剧情、动机、因果或「为什么会这样」。若出现「原来……」「这意味着……」「事实上……」「因为……所以……」「他这样做的原因是……」等解释性句子，或替读者总结本段/前文发生了什么事，判为不通过。情节应通过行动、对话和细节展现（展示而非告知），不得用说明性语句替代。**不误伤**：角色内心的吐槽戏谑、对人或事的个人简短评价、对人物动机的合理猜测、对事件因果的推测等，不判不通过。
...
15. **大幅度改变原始剧情**：待审稿内容必须与【本段提纲】及【前序章节摘要】所确立的剧情方向一致，不得擅自改写关键情节、人物动机、事件结果或世界观设定。若本段正文**明显**偏离提纲要点（如提纲要求写 A 发生、正文却写成 B 发生或 A 未发生）、或与前文已确立的情节/人物状态严重矛盾、或凭空加入提纲与设定中不存在的重要事件或转折，判为不通过，要求重写。**不误伤**：合理的细节扩展、对话与动作的丰富化、以及在不违背提纲前提下的微调不判不通过；仅当出现**大幅度**偏离或颠覆既定剧情时才判不通过。审稿时须在原因中具体说明偏离了哪些要点或与前文/设定何处矛盾。
16. **语境要求阴阳怪气/拌嘴却写得平淡**：当【本段提纲】、【前序章节摘要】或世界观设定中，明确或隐含要求「阴阳怪气」「嘴上不饶人」「互相挤兑」「拌嘴/吵架」「针锋相对」「暗中较劲」「火药味」等风格（例如：本段是争吵、互相损、冷嘲热讽、暗中斗嘴的场景），而【待审稿内容】中的对话却整体语气温和、礼貌、缺乏情绪张力，只是礼貌性交换信息或轻描淡写几句、几乎没有刺痛感和情绪波动，则判为不通过。审稿时需要：1）在原因中明确指出「提纲要求的是带火药味/阴阳怪气/互相挤兑的对话，但正文语气过于平，缺乏情绪冲突」；2）建议作者增加具体的反讽、抬杠、夹枪带棒、冷嘲热讽等带情绪和立场的台词，以及相应的小动作、神态与节奏变化，让对话真正体现出拌嘴/吵架的味道，而不是公事公办地互通信息。
