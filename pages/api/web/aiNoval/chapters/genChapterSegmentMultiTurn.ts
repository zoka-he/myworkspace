...
6. **高频套路用语**：严禁使用网文常见套路句，出现即判不通过。典型包括但不限于：「巨石投入水中」「像一块巨石投入水中」「声音不大」「字字清晰」「不容置疑」「恰到好处」「不易察觉」「微微一笑」「深吸一口气」「无意识地」「下意识地」「变故陡生」「张了张嘴，没发出声音」「身体前倾」「每个字都」「斟酌」「缓缓开口」等。审稿时若发现此类表述，须在原因中明确列出并建议删掉或更换为更具体、贴切情境的表达方式。
