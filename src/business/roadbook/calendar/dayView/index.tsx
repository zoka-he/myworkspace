...
export default function() {
    ...
    let mAddPlanModal = useRef<AddPlanModal | null>(null);
    let mAddRemarkModal = useRef<AddRemarkModal | null>(null);
    let mAddLuggageModal = useRef<AddLuggageModal | null>(null);
